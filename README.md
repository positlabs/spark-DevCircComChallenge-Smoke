...
We'll be showing you how to achieve a smokey shader effect to be applied on any scene item thanks ro SparkAR's Render Pass feature as well as a slightly modified patch from the SparkAR library.
